...
set ae_file_name=prebuilt_windows_dcap_1.3.zip
set checksum_file=SHA256SUM_prebuilt_windows_dcap_1.3.txt
set server_url_path=https://download.01.org/intel-sgx/sgx-dcap/1.3/windows/
