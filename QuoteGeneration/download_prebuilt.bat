...
set ae_file_name=prebuilt_windows_dcap_1.5.zip
set checksum_file=SHA256SUM_prebuilt_windows_dcap_1.5.txt
set server_url_path=https://download.01.org/intel-sgx/sgx-dcap/1.5/windows/
