...
set ae_file_name=prebuilt_windows_dcap_1.10.1.zip
set checksum_file=SHA256SUM_prebuilt_windows_dcap_1.10.1.cfg
set server_url_path=https://download.01.org/intel-sgx/sgx-dcap/1.10.1/windows/
